...
- **「寫勞動日報」**：
  - **執行邏輯**：讀取並嚴格遵循 `勞動日報-prompt.md`。
  - **流程**：搜尋當日勞動時事後，**必須先列出標題清單供使用者挑選**。確認挑選項目後，再生成包含事件經過、違反法條及學習點的完整 MD 檔案。
  - **檔案路徑**：`src/content/notes/勞動/勞動日報/勞動日報-YYYY-MM-DD.md`
- **「寫理財日報」**：
  - **執行邏輯**：聚焦個人理財、稅務、保險與退休規劃。
  - **流程**：篩選 3-5 則與個人財富管理直接相關的新聞，每則需提供「理財點」建議，避開純企業經營或產業動態新聞。
  - **檔案路徑**：`src/content/notes/投資/理財日報/理財日報-YYYY-MM-DD.md`
- **「寫軍事分析」**：
  - **執行邏輯**：針對台海局勢、國際地緣政治或新式武器裝備。
  - **流程**：分析兵力部署、戰術比較或區域防禦策略，重點在於數據對比與戰略意圖解析。
  - **檔案路徑**：`src/content/notes/軍事/[Subcategory]/[Article].md`
