...
| 產品 | 說明 | 路徑 |
|---|---|---|
| **晨會簡報** | 每日投資決策簡報，含結論、市場快覽、焦點討論 | `/notes/Xompass/會議記錄/` |
| **研究報告** | 璞玉報告、總經報告、個股研究、財報筆記 | `/notes/Xompass/研究報告/` |
| **公司底稿** | 各標的靜態事實層（Bible），供論點分析與財報解讀使用 | `/notes/Xompass/公司底稿/` |
| **知識庫** | DSMM 框架、產業傳導鏈、宏觀知識圖譜 | `/notes/Xompass/知識庫/` |
